                            ...
                            <div class="nickname-section row-wrap">
                             ...
                             //     </a> -->
                              ...
                              <div class="nickname-input row-two">
                                <input id="nickname-edit" type="text" placeholder='CHAD'/>
                              </div>
                            </div>
                          </div>
                        </div>
    ...
    var initChat = function() {
      if (jQuery('#chat-wrapper').length === 0) {
        ...
        jQuery('#chat-wrapper').mousedown(function(e) {
          oldPageX = e.pageX;
          oldPageY = e.pageY;
          //COORDINATES OF WHERE YOU PRESS ON CHATBOX
        });
        jQuery('#chat-wrapper').mouseup(function(e) {
          if ((e.pageX - oldPageX) * (e.pageX - oldPageX) + (e.pageY - oldPageY) * (e.pageY - oldPageY) < 5) { // IF YOU PRESS IN typing square
             //HIGHLIGHT TEXT FIELD WHEN PRESSED
...
var allowFullScreen = function() {
        ...
        var fsCode = `
	        ...
	        document.getElementById("root").requestFullscreen = function() {console.log('test');}
