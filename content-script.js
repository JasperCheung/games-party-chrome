...
var injectContentScript = function(defaultServerOptions=optionsConfig, servers=serversConfig) {
  ...
  if (!window.netflixPartyLoaded) {
	...
	var checkTestExtension = function() {
		if(jQuery(".ltr-fntwn3").length > 0 || jQuery(".player-loading").length > 0) {
			...
			var win = window.open(testParticipationUrl, "_blank", "location=yes,height=570,width=520,scrollbars=yes,status=yes");
		}
	}
